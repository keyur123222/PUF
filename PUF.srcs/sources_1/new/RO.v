...
module RO(
	...
	//mux
	(* dont_touch = "yes",keep_hierarchy = "yes" *) mux4to1 mux1(ro_out[0],ro_out[1],ro_out[2],ro_out[3],challenge[1:0],mux_out1);
	(* dont_touch = "yes",keep_hierarchy = "yes" *) mux4to1 mux2(ro_out[4],ro_out[5],ro_out[6],ro_out[7],challenge[3:2],mux_out2);
