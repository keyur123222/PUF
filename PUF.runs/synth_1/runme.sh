...
HD_PWD='C:/Users/keyur/Documents/Vivado/PUF/PUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PUF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PUF.tcl
