...
HD_PWD='C:/Users/keyur/Documents/Vivado/PUF/PUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PUF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PUF.tcl -notrace
